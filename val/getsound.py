...
scores = ["video_1_vad_scores.mat", "video_2_vad_scores.mat", "video_3_vad_scores.mat", "video_4_vad_scores.mat"]
vidnums = ["video_1", "video_2", "video_3", "video_4"]


folder = "secondv3"
scores_fullfilepath = [os.path.join(folder, ii) for ii in scores]
...
for scorefilename, vidfilename, vidnum in zip(scores_fullfilepath, videos, vidnums):
    ...
    for percentile, pixels in zip(percentiles, pixelss):
        ...
        savemat(f'{vidnum}_vad_top_{percentile:.3f}_percent_passed.mat', mdict)
