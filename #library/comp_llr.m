function llr_mean= comp_llr(cleanFile, enhancedFile, srate);
...
len= min( length( cleanFile), length( enhancedFile));
cleanFile= cleanFile( 1: len)+eps;
enhancedFile= enhancedFile( 1: len)+eps;

IS_dist= llr( cleanFile, enhancedFile, srate);
