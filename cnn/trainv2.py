...
# from dataloaders import VoxforgeDataset, read_and_concatenate
# development_set = "..\\voxforge"
# current_dir = os.getcwd()
# fs = 8000
# sounds = [read_and_concatenate(ddd, fs) for ddd in os.listdir()]
# os.chdir(current_dir)
# pickle.dump(sounds, open("sounds.pickle", "wb"))
# sounds = pickle.load(open("sounds.pickle", "rb"))
...
loss_fn = nn.MSELoss()
optimizer = torch.optim.SGD(model.parameters(), lr=0.00001, momentum=0.6, weight_decay=0.3, dampening=0.9)
