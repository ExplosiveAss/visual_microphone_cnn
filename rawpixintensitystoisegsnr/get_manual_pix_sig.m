...
videos = {'video_4'};
vidfilenames = {'..\\Chips1-20000Hz-Mary_Had-input.avi'};
freqs = {20000};
...
for vid_idx = 1:length(videos)
    ...
    segsnrfilename = sprintf('%s_segsnr_manual_pixel_%d_%d.mat', vidnum, segsnrdim1, segsnrdim2);
    stoifilename = sprintf('%s_stoi_manual_pixel_%d_%d.mat', vidnum, stoidim1, stoidim2);
    ...
    segsnrfilename = sprintf('%s_segsnr_manual_pixel_%d_%d.wav', vidnum, segsnrdim1, segsnrdim2);
    stoifilename = sprintf('%s_stoi_manual_pixel_%d_%d.wav', vidnum, stoidim1, stoidim2);
